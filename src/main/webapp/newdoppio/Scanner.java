 ...
 * NOTE FROM PN:
 * 
 * This was found on the internet and was originally used in the "old"
 * Coffeescript/Java 6 Doppio runtime, as the standard Java Scanner was
 * unacceptably slow there.
 *
 * While the standard Scanner works fine with System.in on the "new"
 * Doppio runtime, it seems to hang when handling files. This implementation
 * works fine with files.
 * 
 * It is not intended to be compiled/used in this location. It will be
 * bundled and uploaded with students' code in the scenario that they
 * use both File and Scanner in the same program.
 * 
