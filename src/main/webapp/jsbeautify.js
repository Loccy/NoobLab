...
---------------
  ...
  The options are:
    ...
    brace_style (default "collapse") - "collapse" | "expand" | "end-expand" | "expand-strict"
            put braces on the same line as control statements, or put braces on own line (Allman / ANSI style - default, modded by PN), or just put end braces on own line.
...
function js_beautify(js_source_text, options) {
    ...
    opt_brace_style = options.brace_style ? options.brace_style : (opt_brace_style ? opt_brace_style : "expand");
