...
Blockly.Blocks['procedures_mutatorcontainer'] = {
  ...
  init: function() {
    this.setColour(290);
    this.appendDummyInput()
        .appendField(/* Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE*/"parameters");
    this.appendStatementInput('STACK');
...
Blockly.Blocks['procedures_mutatorarg'] = {
  ...
  init: function() {
    this.setColour(290);
    this.appendDummyInput()
        .appendField(/*Blockly.Msg.PROCEDURES_MUTATORARG_TITLE*/"parameter name:")
...
Blockly.Blocks['procedures_callreturn'] = {
  ...
  init: function() {
    ...
    this.setColour(290);
    this.appendDummyInput()
        .appendField("The value returned by function")
        .appendField('', 'NAME');
    this.setOutput(true);
    // Tooltip is set in domToMutation.
    this.arguments_ = [];
